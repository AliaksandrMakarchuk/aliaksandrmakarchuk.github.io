...
export class Bot2Drawer extends DrawerBase {
    /**
     *
     */
    constructor(context) {
    ...
    Draw(object) {
        ...
        pathStringBuilder
            .GoDown(2).GoRight(1).GoUp(1).GoRight(2)
            .GoDown(1).GoLeft(1).GoDown(1).GoLeft(1).GoDown(1).GoLeft(1)
            .GoDown(3).GoRight(1).GoUp(2).GoRight(1).GoDown(2)
            .GoRight(1).GoDown(1)
            .GoRight(2).GoUp(1).GoLeft(2).GoUp(1)
            .GoRight(6)
            .GoDown(1).GoLeft(2).GoDown(1).GoRight(2).GoUp(1).GoRight(1)
            .GoUp(2).GoRight(1).GoDown(2).GoRight(1).GoUp(3)
            .GoLeft(1).GoUp(1).GoLeft(1).GoUp(1).GoLeft(1).GoUp(1)
            .GoRight(2).GoDown(1).GoRight(1).GoUp(2).GoLeft(3)
            .GoDown(1).GoLeft(1).GoDown(1)
            .GoLeft(4)
            .GoUp(1).GoLeft(1).GoUp(1).GoLeft(3);
        ...
        // --- windows ---
        this.DrawWindow(3, 4, object);
        this.DrawWindow(8, 4, object);
    }
