...
export class BotDrawer extends DrawerBase {
    /**
     *
     */
    constructor(context) {
    ...
    Draw(object) {
        ...
        pathStringBuilder
            ...
            .GoDown(1).GoRight(2)
            .GoDown(1).GoRight(1).GoDown(1).GoRight(1)
            .GoUp(1).GoRight(1).GoUp(1)
            .GoRight(2).GoDown(1)
            .GoRight(2).GoUp(1)
            .GoRight(2).GoDown(1)
            .GoRight(1).GoDown(1).GoRight(1)
            .GoUp(1).GoRight(1).GoUp(1)
            .GoRight(2)
            .GoUp(1)
            .GoLeft(1).GoUp(1).GoLeft(1).GoUp(1).GoLeft(1).GoUp(1)
            .GoLeft(2).GoUp(1).GoLeft(6);
