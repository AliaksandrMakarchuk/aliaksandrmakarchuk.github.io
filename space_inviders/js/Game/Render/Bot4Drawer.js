...
export class Bot4Drawer extends DrawerBase {
    /**
     *
     */
    constructor(context) {
    ...
    Draw(object) {
        ...
        pathStringBuilder
            .GoDown(1).GoLeft(3).GoDown(1).GoLeft(1)
            .GoDown(3).GoRight(2).GoDown(1).GoLeft(1).GoDown(1).GoRight(1).GoDown(1)
            .GoRight(2).GoUp(1).GoLeft(1).GoUp(1).GoRight(2)
            .GoDown(1).GoRight(2).GoUp(1).GoRight(2).GoDown(1).GoLeft(1).GoDown(1)
            .GoRight(2).GoUp(1).GoRight(1).GoUp(1).GoLeft(1).GoUp(1)
            .GoRight(2).GoUp(3)
            .GoLeft(1).GoUp(1)
            .GoLeft(3).GoUp(1)
            .GoLeft(4);
        ...
        this.DrawWindow(0, 4, object);
        this.DrawWindow(3, 4, object);
        this.DrawWindow(4, 4, object);
        this.DrawWindow(1, 6, object);
        this.DrawWindow(2, 6, object);
    }
